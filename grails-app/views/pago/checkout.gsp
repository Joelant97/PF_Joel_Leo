        ...
        <div class="billing_details">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form class="row contact_form" role="form" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post"
                          novalidate="novalidate">
                        <input type="hidden" name="cmd" value="_xclick">
                        <input type="hidden" name="business" value="${cuentaNegocio}">
                        <input type="hidden" name="currency_code" value="USD">
                        <input type="hidden" name="invoice" value="34234">
                        <input type="hidden" name="amount" value="${amount}" required="required">
                        <input type="hidden" name="item_name" value="${item_name}" required="required">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea class="form-control" name="address_override" value=1 rows="1"
                ...
                <div class="col-lg-4">
                    <div class="order_box">
                        ...
                        <button type="submit" class=" btn btn_3">Comprar vía Paypal</button>
                    </div>
                </div>
            </form>
            </div>
